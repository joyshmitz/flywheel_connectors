...
SCRIPT_NAME="e2e_mesh_integration"
SEED="0x1N7"
...
step_run_integration_scenarios() {
  cargo test -p fcp-mesh --test mesh_integration integration_scenarios:: -- --nocapture
}
...
run_step \
  ...
  2 \
  '{"crate":"fcp-mesh","target":"mesh_integration","filter":"integration_scenarios::"}' \
  "" \
  '{"category":"integration","purpose":"meshnode_scenarios"}' \
  step_run_integration_scenarios
