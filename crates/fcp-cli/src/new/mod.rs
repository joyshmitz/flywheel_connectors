...
fn generate_files(
    ...
    let mut files = vec![
        ...
        (
            ...
            generate_manifest_toml(connector_id, short_name, archetype, zone),
...
# TODO: Update interface hash after finalizing operations
...
# Default-deny network constraints
network_constraints = {{ host_allow = [], port_allow = [], require_sni = true }}
