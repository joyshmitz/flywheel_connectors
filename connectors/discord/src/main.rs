//! FCP Discord Connector - Main entrypoint
//!
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Discord Connector starting");
...
async fn handle_message(connector: &mut DiscordConnector, message: &str) -> serde_json::Value {
