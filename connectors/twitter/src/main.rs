//! FCP Twitter/X Connector - Main entrypoint
//!
//! An X/Twitter connector implementing the Flywheel Connector Protocol.
...
fn main() -> Result<()> {
    ...
    tracing::info!("FCP Twitter/X Connector starting");
...
async fn handle_message(connector: &mut TwitterConnector, message: &str) -> serde_json::Value {
